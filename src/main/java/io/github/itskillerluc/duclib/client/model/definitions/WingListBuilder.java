...
public class WingListBuilder extends CubeListBuilder {
    ...
    public @NotNull WingListBuilder addBox(@NotNull String pComment, float pOriginX, float pOriginY, float pOriginZ, int pDimensionX, int pDimensionY, int pDimensionZ, @NotNull CubeDeformation pCubeDeformation, int pXTexOffs, int pYTexOffs) {
        ...
        this.wings.add(new WingDefinition(pComment, advancedUV, pOriginX, pOriginY, pOriginZ, (float)pDimensionX, (float)pDimensionY, (float)pDimensionZ, pCubeDeformation, this.mirror, 1.0F, 1.0F, ALL_VISIBLE));
        return this;
    }
    ...
    public WingListBuilder addBox(String pComment, float pOriginX, float pOriginY, float pOriginZ, float pDimensionX, float pDimensionY, float pDimensionZ, CubeDeformation pCubeDeformation, AdvancedUV[] advancedUVS, boolean mirror) {
        ...
        this.wings.add(new WingDefinition(pComment, advancedUVS, pOriginX, pOriginY, pOriginZ, pDimensionX, pDimensionY, pDimensionZ, pCubeDeformation, mirror, 1.0F, 1.0F, ALL_VISIBLE));
        return this;
    }
    ...
    public @NotNull WingListBuilder addBox(@NotNull String pComment, float pOriginX, float pOriginY, float pOriginZ, int pDimensionX, int pDimensionY, int pDimensionZ, int pXTexOffs, int pYTexOffs) {
        this.texOffs(pXTexOffs, pYTexOffs);
        this.wings.add(new WingDefinition(pComment, this.advancedUV, pOriginX, pOriginY, pOriginZ, (float)pDimensionX, (float)pDimensionY, (float)pDimensionZ, CubeDeformation.NONE, this.mirror, 1.0F, 1.0F, ALL_VISIBLE));
        return this;
    }
    ...
    public @NotNull WingListBuilder addBox(String pComment, float pOriginX, float pOriginY, float pOriginZ, float pDimensionX, float pDimensionY, float pDimensionZ, CubeDeformation deformation, int pXTexOffs, int pYTexOffs, boolean mirror) {
        this.texOffs(pXTexOffs, pYTexOffs);
        this.wings.add(new WingDefinition(pComment, this.advancedUV, pOriginX, pOriginY, pOriginZ, pDimensionX, pDimensionY, pDimensionZ, deformation, mirror, 1.0F, 1.0F, ALL_VISIBLE));
        return this;
    }
    ...
    public @NotNull WingListBuilder addBox(float pOriginX, float pOriginY, float pOriginZ, float pDimensionX, float pDimensionY, float pDimensionZ) {
        this.wings.add(new WingDefinition(null, advancedUV, pOriginX, pOriginY, pOriginZ, pDimensionX, pDimensionY, pDimensionZ, CubeDeformation.NONE, this.mirror, 1.0F, 1.0F, ALL_VISIBLE));
        return this;
    }
    ...
    public @NotNull WingListBuilder addBox(@NotNull String pComment, float pOriginX, float pOriginY, float pOriginZ, float pDimensionX, float pDimensionY, float pDimensionZ) {
        this.wings.add(new WingDefinition(pComment, advancedUV, pOriginX, pOriginY, pOriginZ, pDimensionX, pDimensionY, pDimensionZ, CubeDeformation.NONE, this.mirror, 1.0F, 1.0F, ALL_VISIBLE));
        return this;
    }
    ...
    public @NotNull WingListBuilder addBox(@NotNull String pComment, float pOriginX, float pOriginY, float pOriginZ, float pDimensionX, float pDimensionY, float pDimensionZ, @NotNull CubeDeformation pCubeDeformation) {
        this.wings.add(new WingDefinition(pComment, advancedUV, pOriginX, pOriginY, pOriginZ, pDimensionX, pDimensionY, pDimensionZ, pCubeDeformation, this.mirror, 1.0F, 1.0F, ALL_VISIBLE));
        return this;
    }
    ...
    public @NotNull WingListBuilder addBox(float pOriginX, float pOriginY, float pOriginZ, float pDimensionX, float pDimensionY, float pDimensionZ, boolean pMirror) {
        this.wings.add(new WingDefinition(null, advancedUV, pOriginX, pOriginY, pOriginZ, pDimensionX, pDimensionY, pDimensionZ, CubeDeformation.NONE, pMirror, 1.0F, 1.0F, ALL_VISIBLE));
        return this;
    }
    ...
    public @NotNull WingListBuilder addBox(float pOriginX, float pOriginY, float pOriginZ, float pDimensionX, float pDimensionY, float pDimensionZ, @NotNull CubeDeformation pCubeDeformation, float pTexScaleU, float pTexScaleV) {
        this.wings.add(new WingDefinition(null, this.advancedUV,  pOriginX, pOriginY, pOriginZ, pDimensionX, pDimensionY, pDimensionZ, pCubeDeformation, this.mirror, pTexScaleU, pTexScaleV, ALL_VISIBLE));
        return this;
    }

    @Override
    public @NotNull WingListBuilder addBox(float originX, float originY, float originZ, float dimensionX, float dimensionY, float dimensionZ, @NotNull Set<Direction> visibleFaces) {
        this.wings.add(new WingDefinition(null, this.advancedUV, originX, originY, originZ, dimensionX, dimensionY, dimensionZ, CubeDeformation.NONE, mirror, 1, 1, visibleFaces));
        return this;
    }
    ...
    public @NotNull WingListBuilder addBox(float pOriginX, float pOriginY, float pOriginZ, float pDimensionX, float pDimensionY, float pDimensionZ, @NotNull CubeDeformation pCubeDeformation) {
        this.wings.add(new WingDefinition(null, advancedUV, pOriginX, pOriginY, pOriginZ, pDimensionX, pDimensionY, pDimensionZ, pCubeDeformation, this.mirror, 1.0F, 1.0F, ALL_VISIBLE));
        return this;
    }
