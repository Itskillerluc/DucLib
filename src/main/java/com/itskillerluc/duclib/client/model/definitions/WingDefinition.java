...
public class WingDefinition extends CubeDefinition {
    ...
    private final Ducling.AdvancedUV[] featherUVs;
    private final UVPair texScale;

    protected WingDefinition(@Nullable String pComment, Ducling.AdvancedUV[] featherUVs, float pOriginX, float pOriginY, float pOriginZ, float pDimensionX, float pDimensionY, float pDimensionZ, CubeDeformation pGrow, boolean pMirror, float pTexScaleU, float pTexScaleV) {
